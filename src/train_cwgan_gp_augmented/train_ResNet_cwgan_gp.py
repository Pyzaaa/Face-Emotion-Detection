...
def train_resnet50_cwgan():
    ...
    for epoch in range(EPOCHS):
        ...
        if val_acc > best_acc:
            best_acc = val_acc
            torch.save(model.state_dict(), "models/resnet50_cwgan_gp_best.pth")
            print("Zapisano nowy najlepszy model (cwgan_gp).")

    print("\nTrening ResNet50 (cwgan_gp) zakończony. Najlepsza dokładność:", best_acc)

    with open(summary_path, "w") as f:
        f.write("ResNet50 cwgan_gp train on balanced dataset\n")
